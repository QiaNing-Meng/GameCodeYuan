...
public class PlayerQin : MonoBehaviour
{
    ...
    void SetupAnimator() {
        ...
        else if (playerPosture == PlayerPosture.Jumping)
        {
            ...
            animator.SetFloat(verticalVelecityHash, verticalVelecity,0.15f,Time.deltaTime);
    ...
    {
        if (currentAimState != isAttackMode)
        {
            currentAimState = isAttackMode;
            animator.SetBool("isAiming", isAttackMode);
        }
    ...
    #region 输入相关
    public void TouchMoveInput(Vector2 vector2) {
        this.moveInput = vector2;
    }
    ...
    public void TouchSkill1Attack() {
        ...
        if (skill1 == false)
        {
            if (GameStart.Instance._SkillManager.ReleaseSkill(1))
            {
                animator.SetTrigger("Skill1");
                //animator.Play("s1");
                StartCoroutine(RefreshSkillCd(skill1, 3f));
            }
        }
        else
        {
    ...
    public void GetSkill1(InputAction.CallbackContext context) {
        if (skill1 == false)
        {
            if (GameStart.Instance._SkillManager.ReleaseSkill(1))
            {
    ...
    IEnumerator RefreshSkillCd(bool _skill,float time)
    {
        skill1 = true;
    ...
    public void GetEnterExitAttackModeInput(InputAction.CallbackContext context)
    {
        isAttackMode = !isAttackMode;
    }
    ...
    {
        //isAttackMode = context.ReadValueAsButton();
    }
